...
void err_401();//401
void check_token(struct mg_connection *c,char *user,char*token);//验证token
void check_action(struct mg_connection *c,char*user,char*token,char*control,char*action);//检查操作权限
